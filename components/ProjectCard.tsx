...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <>
      <Card className="flex flex-col h-full overflow-hidden group relative !bg-card hover:!bg-card-hover backdrop-blur-sm border-2 border-border/50 hover:border-accent/50 transition-all duration-500 hover:shadow-2xl hover:shadow-accent/5 hover:-translate-y-1">
        ...
        <div className="relative w-full h-40 md:h-48 bg-muted overflow-hidden border-b border-border/50">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 backdrop-blur-sm bg-background/10">
            <Button 
              variant="default" 
              className="rounded-full px-5 py-4 gap-2 font-semibold shadow-2xl scale-90 group-hover:scale-100 transition-all duration-500 ease-out text-sm"
